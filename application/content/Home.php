<div class="wrapper">
    <div class="main">
        ...
        <section class="page2">
            <div class="page_container">
                <div class="about-text">
                    <img class="circular-square" alt="" src="../media/images/outside_self_square.jpg" />
                    <h2>About: My Journey to Today</h2>
                    <p>During college and throughout my first 6+ years of my professional career, I have grown my knowledge of numerous languages, enhanced my work ethic, and was provided with an amazing experience.</p>
                    <p>Now working full-time in downtown Washington DC as a developer, I specialize in creating fully responsive websites and software management products.</p>
                </div>
            </div>
        </section>
        ...
        <section class="page4">
            <div class="page_container">
                <div class="about">
                    <p class="carousel-text">Coming Soon: Portfolio! Need to speak with clients to get approval for posting screenshots.</p>
                    <div id="owl-portfolio" class="owl-carousel owl-theme">
                        <div class="item"><img src="http://placehold.it/1170x300/42bdc2/FFFFFF" alt="" /></div>
                        <div class="item"><img src="http://placehold.it/1170x300/42bdc2/FFFFFF" alt="" /></div>
                        <div class="item"><img src="http://placehold.it/1170x300/42bdc2/FFFFFF" alt="" /></div>
                    </div>
                </div>
